...
<div id="bgslider">
	...
	<div class="ws_images"><ul>
		<li><img src="data1/images/1.jpeg" alt="" width="300px" title="" id="wows1_0"/></li>
		<li><a href="http://wowslider.com/vf"><img src="data1/images/2.jpeg" width="300px" alt="full screen slider" title="full screen slider" id="wows1_1"/></a></li>
		<li><img src="data1/images/3.jpeg" width="300px" alt="" title="" id="wows1_2"/></li>
        <li><img src="data1/images/4.jpeg" width="300px" alt="" title="" id="wows1_2"/></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title=""><img src="data1/tooltips/1.jpeg" width="300px" alt=""/></a>
		<a href="#" title="full screen slider"><img src="data1/tooltips/2.jpeg" width="300px" alt="full screen slider"/></a>
		<a href="#" title=""><img src="data1/tooltips/3.jpeg" width="300px" alt=""/></a>
        <a href="#" title=""><img src="data1/tooltips/4.jpeg" width="300px" alt=""/></a>
    ...
    <br>
<h2>Sundanese Food Series Menjual :</h2>
<li>Cireng Banyur</li>
<li>Cireng Rujak</li>
<li>Tahu Walik</li>
<li>Tempe Mercon</li> <br>

<h2>Harga Produk Yang Dijual</h2>
<li>Cireng Banyur Rp. 10.000/porsi</li>
<li>Cireng Rujak Rp. 10.000/porsi</li>
<li>Tahu Walik Rp. 2.500/satuan</li>
<li>Tempe Mercon Rp. 2.500/satuan</li>
